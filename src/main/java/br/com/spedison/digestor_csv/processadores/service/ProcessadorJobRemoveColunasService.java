...
import br.com.spedison.digestor_csv.processadores.ProcessadorRemoveColunas;
...
@Service
public class ProcessadorJobRemoveColunasService {
    ...
    @Autowired
    @Inject
    private ProcessadorRemoveColunas processadorFiltro;
